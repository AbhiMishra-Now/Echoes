...
export type ApiChapter = { id: string; biography_id: string; user_id: string; title: string; description: string; time_period?: string; cover_image?: string; order: number; created_at: string; updated_at: string; narrative_text?: string; themes?: string[]; layout?: any[]; messages?: any[] };
