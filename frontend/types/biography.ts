...
export interface Chapter { id: string; title: string; description: string; timePeriod?: string; coverImage?: string; order: number; createdAt: Date; updatedAt: Date; layout?: any[]; bookSpreads?: any[][]; }
