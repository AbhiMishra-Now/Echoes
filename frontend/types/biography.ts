...
export interface Chapter { id: string; title: string; description: string; timePeriod?: string; coverImage?: string; order: number; createdAt: Date; updatedAt: Date; layout?: any[]; }
...
export interface Message { id: string; chapterId: string; sender: "user" | "ai"; content: string; media?: MediaItem[]; category?: string; timestamp: Date; isEdited: boolean; metadata?: { voiceNote?: boolean; transcription?: string; }; }
